...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/404',   meta: { name: '404找不到页面', title: '404页面', guest: true }, component: () => import('../views/404.vue') },
    { path: '/login', meta: { name: '登录系统', title: '欢迎登录电影购票系统', guest: true }, component: () => import('../views/Login.vue') },
    { path: '/register', meta: { name: '注册页面', title: '欢迎注册电影购票系统', guest: true }, component: () => import('../views/Register.vue') },
