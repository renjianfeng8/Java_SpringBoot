<template>
  <div>
    <div class="card mb-2">
      <el-input v-model="searchForm.title" placeholder="请输入分类名称" class="mr-2 w-72" :prefix-icon="Search" />
    ...
    <el-dialog v-model="dialogVisible" title="电影分类信息" width="500" destroy-on-close>
